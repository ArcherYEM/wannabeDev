...
COMMENT ON COLUMN WNB_TEST.USER_DETAIL.HOMPIE_USE_YN IS '홈피 사용 여부';
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE (
                                 HOMPIE_ID VARCHAR2(40),
                                 HOMPIE_URL VARCHAR2(100),
                                 HOMPIE_TITLE VARCHAR2(50),
                                 ...
                                 UPDATE_USER_ID VARCHAR2(40),
                                 UPDATE_DT DATE,
                                 CONSTRAINT HOMPIE_PK PRIMARY KEY (HOMPIE_ID)
);

-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE IS '미니홈피 기본';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE.HOMPIE_ID IS '홈피 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE.HOMPIE_URL IS '홈피 URL';
COMMENT ON COLUMN WNB_TEST.HOMPIE.HOMPIE_TITLE IS '홈피 머리글';
COMMENT ON COLUMN WNB_TEST.HOMPIE.OWNER_USER_ID IS '오너 회원 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE.UPDATE_USER_ID IS '변경자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE.UPDATE_DT IS '변경일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_CONFIG (
                                        HOMPIE_ID VARCHAR2(40),
                                        HOMPIE_CONFIG_CODE VARCHAR2(2) NOT NULL,
                                        HOMPIE_CONFIG_CONTENT VARCHAR2(400),
                                        REMARKS VARCHAR2(500),
                                        INSERT_USER_ID VARCHAR2(40),
                                        INSERT_DT DATE DEFAULT SYSDATE NOT NULL,
                                        UPDATE_USER_ID VARCHAR2(40),
                                        UPDATE_DT DATE,
                                        CONSTRAINT HOMPIE_CONFIG_PK PRIMARY KEY (HOMPIE_ID)
);


-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_CONFIG IS '홈피 설정';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_CONFIG.HOMPIE_ID IS '홈피 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_CONFIG.HOMPIE_CONFIG_CODE IS '홈피 설정 코드';
COMMENT ON COLUMN WNB_TEST.HOMPIE_CONFIG.HOMPIE_CONFIG_CONTENT IS '홈피 설정 내용';
COMMENT ON COLUMN WNB_TEST.HOMPIE_CONFIG.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_CONFIG.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_CONFIG.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_CONFIG.UPDATE_USER_ID IS '변경자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_CONFIG.UPDATE_DT IS '변경일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_MENU (
                                      HOMPIE_ID VARCHAR2(40),
                                      HOMPIE_MENU_CODE VARCHAR2(2),
                                      AVAIL_STATUS VARCHAR2(2) NOT NULL,
                                      REMARKS VARCHAR2(500),
                                      INSERT_USER_ID VARCHAR2(40),
                                      INSERT_DT DATE DEFAULT SYSDATE NOT NULL,
                                      UPDATE_USER_ID VARCHAR2(40),
                                      UPDATE_DT DATE,
                                      CONSTRAINT HOMPIE_MENU_PK PRIMARY KEY (HOMPIE_ID, HOMPIE_MENU_CODE)
);

-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_MENU IS '홈피 메뉴';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_MENU.HOMPIE_ID IS '홈피 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_MENU.HOMPIE_MENU_CODE IS '홈피 메뉴 코드';
COMMENT ON COLUMN WNB_TEST.HOMPIE_MENU.AVAIL_STATUS IS '상태';
COMMENT ON COLUMN WNB_TEST.HOMPIE_MENU.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_MENU.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_MENU.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_MENU.UPDATE_USER_ID IS '변경자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_MENU.UPDATE_DT IS '변경일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_FRIEND_COMMENT (
                                                HOMPIE_ID VARCHAR2(40),
                                                ...
                                                UPDATE_USER_ID VARCHAR2(40),
                                                UPDATE_DT DATE,
                                                CONSTRAINT HOMPIE_FRIEND_COMMENT_PK PRIMARY KEY (HOMPIE_ID, WRITE_USER_ID)
);

-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_FRIEND_COMMENT IS '일촌평 관리';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_FRIEND_COMMENT.HOMPIE_ID IS '홈피 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_FRIEND_COMMENT.WRITE_USER_ID IS '글쓴이 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_FRIEND_COMMENT.FRIEND_COMMENTS IS '일촌 코멘트';
COMMENT ON COLUMN WNB_TEST.HOMPIE_FRIEND_COMMENT.FIXED_YN IS '고정 여부';
COMMENT ON COLUMN WNB_TEST.HOMPIE_FRIEND_COMMENT.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_FRIEND_COMMENT.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_FRIEND_COMMENT.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_FRIEND_COMMENT.UPDATE_USER_ID IS '수정자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_FRIEND_COMMENT.UPDATE_DT IS '수정일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_DAILY_STATS (
                                             HOMPIE_ID VARCHAR2(40),
                                             ...
                                             UPDATE_USER_ID VARCHAR2(40),
                                             UPDATE_DT DATE,
                                             CONSTRAINT HOMPIE_DAILY_STATS_PK PRIMARY KEY (HOMPIE_ID, DAY_STATS_DATE)
);

-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_DAILY_STATS IS '홈피 일별 통계';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_DAILY_STATS.HOMPIE_ID IS '홈피 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DAILY_STATS.DAY_STATS_DATE IS '일일 투데이';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DAILY_STATS.TODAY_CNT IS '투데이 수';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DAILY_STATS.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DAILY_STATS.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DAILY_STATS.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DAILY_STATS.UPDATE_USER_ID IS '수정자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DAILY_STATS.UPDATE_DT IS '수정일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_DIARY (
                                       HOMPIE_ID VARCHAR2(40),
                                       ...
                                       UPDATE_USER_ID VARCHAR2(40),
                                       UPDATE_DT DATE,
                                       CONSTRAINT HOMPIE_DIARY_PK PRIMARY KEY (HOMPIE_ID, DIARY_ID)
);


-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_DIARY IS '홈피 다이어리';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY.HOMPIE_ID IS '홈피 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY.DIARY_ID IS '다이어리 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY.DIARY_NAME IS '다이어리명';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY.AVAIL_STATUS IS '상태';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY.UPDATE_USER_ID IS '변경자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY.UPDATE_DT IS '변경일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_DIARY_CONTENT (
                                               DIARY_ID VARCHAR2(40),
                                               ...
                                               UPDATE_USER_ID VARCHAR2(40),
                                               UPDATE_DT DATE,
                                               CONSTRAINT HOMPIE_DIARY_CONTENT_PK PRIMARY KEY (DIARY_ID, CONTENTS_ID)
);


-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_DIARY_CONTENT IS '홈피 다이어리 내용';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY_CONTENT.DIARY_ID IS '다이어리 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY_CONTENT.CONTENTS_ID IS '다이어리 내용 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY_CONTENT.DIARY_TITLE IS '다이어리 제목';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY_CONTENT.DIARY_CONTENT IS '다이어리 내용';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY_CONTENT.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY_CONTENT.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY_CONTENT.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY_CONTENT.UPDATE_USER_ID IS '변경자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_DIARY_CONTENT.UPDATE_DT IS '변경일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_ALBUM (
                                       HOMPIE_ID VARCHAR2(40),
                                       ...
                                       UPDATE_USER_ID VARCHAR2(40),
                                       UPDATE_DT DATE,
                                       CONSTRAINT HOMPIE_ALBUM_PK PRIMARY KEY (HOMPIE_ID, ALBUM_ID)
);

-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_ALBUM IS '미니홈피 사진첩';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM.HOMPIE_ID IS '홈피 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM.ALBUM_ID IS '사진첩 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM.ALBUM_NAME IS '사진첩 이름';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM.AVAIL_STATUS IS '상태';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM.UPDATE_USER_ID IS '변경자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM.UPDATE_DT IS '변경일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_ALBUM_CONTENT (
                                               ALBUM_ID VARCHAR2(40),
                                               CONTENTS_ID VARCHAR2(40),
                                               ...
                                               UPDATE_USER_ID VARCHAR2(40),
                                               UPDATE_DT DATE,
                                               CONSTRAINT HOMPIE_ALBUM_CONTENT_PK PRIMARY KEY (ALBUM_ID, CONTENTS_ID)
);

-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_ALBUM_CONTENT IS '미니홈피 사진첩 내용';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM_CONTENT.CONTENTS_ID IS '내용 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM_CONTENT.ALBUM_ID IS '사진첩 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM_CONTENT.ALBUM_TITLE IS '사진첩 제목';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM_CONTENT.ALBUM_CONTENT IS '사진첩 내용';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM_CONTENT.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM_CONTENT.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM_CONTENT.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM_CONTENT.UPDATE_USER_ID IS '변경자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_ALBUM_CONTENT.UPDATE_DT IS '변경일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_BOARD (
                                       HOMPIE_ID VARCHAR2(40),
                                       HOMPIE_BOARD_ID VARCHAR2(40),
                                       HOMPIE_BOARD_TITLE VARCHAR2(200),
                                       HOMPIE_BOARD_CONTENT VARCHAR2(50),
                                       REMARKS VARCHAR2(500),
                                       INSERT_USER_ID VARCHAR2(40),
                                       INSERT_DT DATE DEFAULT SYSDATE NOT NULL,
                                       UPDATE_USER_ID VARCHAR2(40),
                                       UPDATE_DT DATE,
                                       CONSTRAINT HOMPIE_BOARD_PK PRIMARY KEY (HOMPIE_ID, HOMPIE_BOARD_ID)
);

-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_BOARD IS '홈피 게시판';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD.HOMPIE_ID IS '홈피 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD.HOMPIE_BOARD_ID IS '게시판 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD.HOMPIE_BOARD_TITLE IS '게시판 제목';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD.HOMPIE_BOARD_CONTENT IS '게시판 내용';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD.UPDATE_USER_ID IS '변경자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD.UPDATE_DT IS '변경일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_BOARD_ATTACH (
                                              HOMPIE_BOARD_ID VARCHAR2(40),
                                              HOMPIE_BOARD_ATTACH_ID VARCHAR2(40),
                                              ...
                                              UPDATE_USER_ID VARCHAR2(40),
                                              UPDATE_DT DATE,
                                              CONSTRAINT HOMPIE_BOARD_ATTACH_PK PRIMARY KEY (HOMPIE_BOARD_ID, HOMPIE_BOARD_ATTACH_ID)
);


-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_BOARD_ATTACH IS '게시판 첨부';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD_ATTACH.HOMPIE_BOARD_ID IS '게시판 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD_ATTACH.HOMPIE_BOARD_ATTACH_ID IS '게시판 첨부 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD_ATTACH.ATTACH_FILE_ID IS '파일ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD_ATTACH.USE_YN  IS '사용 여부';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD_ATTACH.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD_ATTACH.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD_ATTACH.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD_ATTACH.UPDATE_USER_ID IS '수정자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_BOARD_ATTACH.UPDATE_DT IS '수정일시';
/**
 * ==============================================END==============================================
*/
 ...
 * =============================================START=============================================
 */
CREATE TABLE WNB_TEST.HOMPIE_GUEST_BOOK (
                                            HOMPIE_ID VARCHAR2(40),
                                            ...
                                            UPDATE_USER_ID VARCHAR2(40),
                                            UPDATE_DT DATE,
                                            CONSTRAINT HOMPIE_GUEST_BOOK_PK PRIMARY KEY (HOMPIE_ID, GUEST_BOOK_ID)
);

-- 테이블 코멘트 추가
COMMENT ON TABLE WNB_TEST.HOMPIE_GUEST_BOOK IS '미니홈피 방명록';

-- 컬럼별 코멘트 추가
COMMENT ON COLUMN WNB_TEST.HOMPIE_GUEST_BOOK.HOMPIE_ID IS '홈피 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_GUEST_BOOK.GUEST_BOOK_ID IS '방명록 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_GUEST_BOOK.GUEST_BOOK_CONTENT IS '방명록 내용';
COMMENT ON COLUMN WNB_TEST.HOMPIE_GUEST_BOOK.REMARKS IS '비고';
COMMENT ON COLUMN WNB_TEST.HOMPIE_GUEST_BOOK.INSERT_USER_ID IS '등록자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_GUEST_BOOK.INSERT_DT IS '등록일시';
COMMENT ON COLUMN WNB_TEST.HOMPIE_GUEST_BOOK.UPDATE_USER_ID IS '변경자 ID';
COMMENT ON COLUMN WNB_TEST.HOMPIE_GUEST_BOOK.UPDATE_DT IS '변경일시';
/**
 * ==============================================END==============================================
*/
...
CREATE TABLE WNB_TEST.BGM (
                              ...
                              REMARKS VARCHAR2(500),
                              IMAGE_FILE_ATTACH_ID VARCHAR2(40) NOT NULL,
                              INSERT_USER_ID VARCHAR2(40),
                              INSERT_DT DATE DEFAULT SYSDATE NOT NULL,
                              UPDATE_USER_ID VARCHAR2(40),
                              UPDATE_DT DATE,
...
COMMENT ON COLUMN WNB_TEST.BGM.BGM_FILE_ATTACH_IDD IS 'BGM 파일 ID';
